...
//		System.out.print("words.size(): "+words.size());
	...
	public int getNumSentences()
	{
		...
		List<String> sentences = getTokens("[^.!?]+");		//	System.out.println("With punc:		"+sentences);
//		List<String> sentNoPeriod = getTokens("[a-z]+\n");		System.out.println("No punc:			"+sentNoPeriod);
//		sentences.addAll(sentNoPeriod);							System.out.println("Final sentence list: "+sentences);
	...
	public int getNumSyllables()
	{
		...
		for(String word: wordsList) {
			 int syllcount=0;
			 syllcount = countSyllables(word);
			 numSyllables += syllcount;
//			 System.out.println("Word: \""+word+"\", Syllables: "+syllcount);
		} 
		
//		System.out.println("numSyllables in test: "+numSyllables);
        return numSyllables;
	}
